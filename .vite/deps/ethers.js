...
var _BaseContract = class _BaseContract {
  ...
  constructor(target, abi, runner, _deployTx) {
    ...
    return new Proxy(this, {
      get: (target2, _prop, receiver) => {
        if (_prop in target2 || passProperties2.indexOf(_prop) >= 0 || typeof _prop === "symbol") {
          return Reflect.get(target2, _prop, receiver);
        }
        const prop = String(_prop);
      ...
      has: (target2, prop) => {
        if (prop in target2 || passProperties2.indexOf(prop) >= 0 || typeof prop === "symbol") {
          return Reflect.has(target2, prop);
        }
